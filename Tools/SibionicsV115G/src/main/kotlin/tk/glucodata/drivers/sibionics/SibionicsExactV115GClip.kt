...
private fun uLt(a: Int, b: Int): Boolean = a.toUInt() < b.toUInt()
private fun uLe(a: Int, b: Int): Boolean = a.toUInt() <= b.toUInt()
private fun uGt(a: Int, b: Int): Boolean = a.toUInt() > b.toUInt()
private fun uGe(a: Int, b: Int): Boolean = a.toUInt() >= b.toUInt()
private fun u64ToDouble(value: Long): Double = value.toULong().toString().toDouble()
